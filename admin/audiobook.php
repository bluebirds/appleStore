	   ...
	   <?php include 'header.php'; ?> <!--//  header -->
			...
			<div id="content">
				...
				<div class="inner">
				  ...
				  <div class="header"><span ><span class="ico  gray connect"></span>Add & Delete audio Books</span> </div><!-- End header -->	
				  ...
				  <div class="content" >
					  ...
					  <ul class="tabs" > 
						  ...
						  <li ><a href="#tab2"  id="3"  > Delete Audio Book</a></li>			
					...
					<div class="tab_container" >
						  ...
						  <div id="tab2" class="tab_content"> 
							  ...
							  <ul class="uibutton-group">
									...
									<li><span class="tip"><a class="uibutton icon add on_load"  name="#tab1"  title="Click Add Product">Add audio Book</a></span></li>
							  ...
							  <table class="display data_table2 " id="data_table">
								...
								<thead>
								  ...
								  <tr>
									...
									<th width="352" align="left">Namess</th>
						...
						<div class="header"> <span ><span class="ico gray software24 "></span> MutiUpload and  editor Full  Width</span></div>

						<div class="clear"></div>

						<div class="content" >

						<div class="boxtitle"> <span class="ico gray upload2 "></span>  MutiUpload Picture  and ( Text editor Full  Width )</div>		
