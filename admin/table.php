       ...
       <?php include 'header.php'; ?> <!--//  header -->
            ...
            <div id="content">
                <div class="inner">
                    ...
                    <div class="onecolumn" >
                    <div class="header">
                    <span ><span class="ico  gray spreadsheet"></span> Static table </span>
                    </div><!-- End header -->	
                    <div class=" clear"></div>
                    <div class="content" >
...
<table class="display data_table2" >
	<thead>
		<tr>
			<th><div class="th_wrapp">Rendering engine</div></th>
			<th><div class="th_wrapp">Browser</div></th>
			<th><div class="th_wrapp">Platform(s)</div></th>
			<th><div class="th_wrapp">Engine version</div></th>
			<th><div class="th_wrapp">CSS grade</div></th>
		</tr>
	</thead>
	<tbody>
		<tr class="odd gradeX">
		...
		<tr class="gradeU">
			...
			<td class="center">U</td>
                  ...
                  <div class="onecolumn" >
                  <div class="header"><span ><span class="ico  gray arrow_bidirectional"></span>Table in Tab</span> </div><!-- End header -->	
                  <div class="clear"></div>
                  <div class="content" >
                  
                      <div id="uploadTab">
                      <ul class="tabs" >
                          <li ><a href="#tab1"   >   inTab  </a></li>  
                          <li ><a href="#tab2"   >   with toolbar <img src="images/icon/new.gif" width="20" height="9" /></a></li>            
                      </ul>
                            ...
                            <div class="load_page">
                              ...
                              <table class="display data_table3"  id="data_table3">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td  width="35" ><input type="checkbox" name="checkbox[]" class="chkbox"  id="check22"/></td>
                                    <td  align="left">B ring</td>
                                    <td >ring B</td>
                                    <td >RD115560</td>
                                    <td >
                                  ...
                                  <tr>
                                    <td  width="35" ><input type="checkbox" name="checkbox[]" class="chkbox"  id="check33"/></td>
                                    <td  align="left">C ring</td>
                                    <td >ring C</td>
                                    <td >RD115561</td>
                                    <td >
                                  ...
                                  <tr>
                                    <td  width="35" ><input type="checkbox" name="checkbox[]" class="chkbox"  id="check44"/></td>
                                    <td  align="left">D ring</td>
                                    <td >ring D</td>
                                    <td >RD115562</td>
                                    <td >
                                  ...
                                  <tr>
                                    <td  width="35" ><input type="checkbox" name="checkbox[]" class="chkbox"  id="check55"/></td>
                                    <td  align="left">E ring</td>
                                    <td >ring E</td>
                                    <td >RD115562</td>
                                    <td >
